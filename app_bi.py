...
from tensorflow.keras.layers import Input, Embedding, LSTM, Flatten, Dense, Bidirectional
...
x = Bidirectional(LSTM(10, return_sequences=True, recurrent_dropout=0.2))(x)  
x = Flatten()(x)  
...
model.load_weights('model_bi_chatbot_kampus_merdeka.h5')
